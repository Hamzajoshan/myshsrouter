...
class index extends Component {
  ...
  //Handle Chat Message when enter key is pressed
                  ...
                  <div className="wrap pt-4">
                    <div className="col-md-12">
                      ...
                      <div className="search">
                        <p>
                          {/* <Link
                            to={`/givereviews/${this.state.result.serviceProvider.user.id}/${this.state.result.customer.user.id}/${this.state.projectId}`}
                          >
                            <span
                              className="icon"
                              style={{
