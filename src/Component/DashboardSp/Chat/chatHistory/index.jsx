...
class index extends Component {
  ...
  componentWillReceiveProps(newProps) {
    ...
    fetch(
      `https://shsbackend.azurewebsites.net/api/services/app/Chat/GetAllDetailChatByUserAsync?UserId=${fromId}&OtherUserId=${toId}`,
      {
        headers: {
  ...
  handleChatMessage = e => {
    ...
    if (chatMessage === "") {
      ...
      $(this.refs["ChatBox"]).focus();
      fetch(
        "https://shsbackend.azurewebsites.net/api/services/app/Chat/AddChatAsync",
        {
          method: "post",
          headers: {
            "Content-Type": "application/json",
